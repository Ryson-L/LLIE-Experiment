...
from models.modules.loss import hist_loss, portrait_l1_loss
...
class LLFlowModel(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        weight_l1 = opt_get(self.opt, ['train', 'weight_l1']) or 0
        weight_portrait_l1 = opt_get(self.opt, ['train', 'weight_portrait_l1']) or 0
        ...
        need_sr = (weight_l1 > 0) or (weight_portrait_l1 > 0)
        if need_sr:
            z = self.get_z(
                heat=0,
                seed=None,
        ...
        # Portrait-region loss
        if weight_portrait_l1 > 0:
            lp = portrait_l1_loss(sr, self.real_H, self.seg_map, person_id=36)
            losses['portrait_l1_loss'] = weight_portrait_l1 * lp
