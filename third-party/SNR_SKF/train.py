                ...
                # if True and rank <= 0:  # image restoration validation
                    ...
                    if opt['dist']:
                        ...
                        for val_data in val_loader:
                            ...
                            # 保存每个阶段的生成图
                            if rank <= 0:  # 单卡时 rank=-1；多卡只在主进程存图
                                epoch_like = current_step // opt['train']['val_freq']  # 这里 val_freq=35

                                # folder 类似 '0186.png'，我们只要 ID
                                base_name = os.path.splitext(folder)[0]  # -> '0186'

                                # 目标文件名：Epoch001_0186_Pred.png
                                img_name = 'Epoch{:03d}_{}_Pred.png'.format(epoch_like, base_name)
